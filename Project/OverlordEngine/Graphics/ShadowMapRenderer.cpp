...
void ShadowMapRenderer::UpdateMeshFilter(const SceneContext& sceneContext, MeshFilter* pMeshFilter) const
{
	...
	const MaterialTechniqueContext& curTechnique{ m_GeneratorTechniqueContexts[static_cast<int>(curType)] };
	...
	pMeshFilter->BuildVertexBuffer(sceneContext, curTechnique.inputLayoutID, curTechnique.inputLayoutSize, curTechnique.pInputLayoutDescriptions);
}
